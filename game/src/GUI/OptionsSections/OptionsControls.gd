...
var ActionBind:PackedScene = preload("res://src/GUI/ReBindSection/ActionBind.tscn")
var ControlBind:PackedScene = preload("res://src/GUI/ReBindSection/ControlBind.tscn")
...
func _ready()->void:
	set_action_list()
	GuiEvent.connect("Controls", self, "show_controls")
	#localization
